                    ...
                    <div class="relative flex items-center
                     justify-between">
                        <Link to="/"
                            ...
                            >Knowledge Education</span>
                        </Link>
                        <ul class="flex items-center hidden 
                        space-x-8 lg:flex">
                            <li><Link to="/"
                                aria-label="Home"
                                title="Home"
                             ...
                             -none focus:shadow-outline">
                                <svg class="w-5 text-gray-600"
                                    ...
                                    <path fill="currentColor"
                                        d="M23,13H1c-0.6,0-1-0.4-1-
                                     1s0.4-1,1-1h22c0.6,0,1,0.4,
                                     1,1S23.6,13,23,13z"></path>
                                    <path fill="currentColor"
                                        d="M23,6H1C0.4,6,0,5.6,0,
                                     5s0.4-1,1-1h22c0.6,0,1,0.4,1
                                     ,1S23.6,6,23,6z"></path>
                                    <path fill="currentColor"
                                        d="M23,20H1c-0.6,0-1-0.4-1-
                                     1s0.4-1,1-1h22c0.6,0,1,0.4,1
                                     ,1S23.6,20,23,20z"></path>
                                </svg>
                            </button>
                             ...
                             justify-between mb-4">
                                 ...
                                 deep-purple-accent-400"
                                         ...
                                         font-bold tracking-wide
                                          text-gray-800 uppercase">Knowledge Education</span>
                                                </Link>
                                            </div>
                                            <div>
